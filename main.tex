...
To further assess the performance of server-client simulation archeture, we also compile the benchmark circuits to OpenQASM and run them directly on the Cirq and Qiskit simulators using Python.
