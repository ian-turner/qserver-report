...
A comparison of code representing a Bell state preparation circuit in both Proto-Quipper, QServer, and OpenQASM is
...
This dynamic is analogous to how classical languages such as Python or Java compile higher-level code
...
% \caption{Python-like pseudo-code for measuring a qubit. }
