...
\institute{Department of Computer Science and Computer Engineering, University of South Carolina, Columbia, South Carolina, USA}
...
\begin{abstract}
    ...
    This is due to third-party simulators
    ...
    portion of the circuit. This is also known as \textit{dynamic circuits} in
    Qiskit.
    ...
    Although these simulators have limited support for dynamic circuits,
    we are able to execute much more complicated programs by only slightly extending
    ...
    and simulators.
    Finally, we optimize our simulators using instruction queuing and
...
While the capability of dynamic lifting allows programmers to create much more complex circuits than
would be feasible to directly implement in Cirq or Qiskit, it greatly increases the
complexity of the simulation of such programs, since static circuit objects cannot be created,
and communication between the simulator and language interpreter is needed during simulation time.
...
Proto-Quipper is a family of functional quantum programming languages designed to give a formal foundation to Quipper \cite{}.
...
The types \textbf{Qubit} and \textbf{Bit} are considered \textit{linear resources}, meaning they cannot be duplicated
or discarded.
...
\begin{enumerate}
	...
	\item Describe the difficulties of integrating high-level quantum programming languages
		with quantum simulators and quantum hardware

    % Talk about OpenQASM conversion written in Haskell

    % Extend existing architecture, mention Python
	\item Develop a simulation architecture for real-time simulation of Proto-Quipper programs
		with third-party simulators from Cirq and Qiskit through conversion to OpenQASM

	\item Implement optimization of simulations through instruction queuing and benchmark the
		performance improvement

\end{enumerate}

Code available at: \href{https://github.com/ian-turner/pyqserver}
