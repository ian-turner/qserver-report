...
be ran on the state-of-the-art quantum simulators.
In particular, we build a Proto-Quipper circuits to
OpenQasm converter, and an interpretor 
that can run Proto-Quipper programs that use dynamic lifting.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{{ ./images/qft.png }}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{{ ./images/maxcut.png }}
\caption{MaxCut QAOA}
\label{fig:maxcut}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{{ ./images/tele.png }}
