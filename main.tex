...
and a qubit index and return the collapsed statevector and measurement result. See the following
Qiskit program. 
...
\caption{Python-like pseudo-code for measuring a qubit. The `remove' function here is a placeholder
...
An example of instruction queuing is given in Figure \ref{fig:queued_circ}.
