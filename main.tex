...
run through the simulator. However, if using the queueing technique,
...
When evaluating \texttt{bellMeas}, the Proto-Quipper interpretor will generate the
following QServer commands:
\[
\texttt{Q 0; H 0; Q 1; CNOT 1 0; M 0; R 0; M 1; R 1}
\]
Here \texttt{Q}, \texttt{M} and \texttt{R} are the intialization, measurement and the
read commands respectively. When receiving the measuremnt commands, the our Qiskit simulation server will generate the following OpenQasm code.
...
the client-server simulation archeture, this
